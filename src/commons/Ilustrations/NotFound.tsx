...
const NotFound = ({ width, height }: ColorProps) => (
    <svg width={width} height={height} viewBox="0 0 672.532 738.394">
        ...
        <path
            fill="#2f2e41"
            d="m347.239 489.72 5.715-11.413 20.447 10.24-5.715 11.412z"
        ></path>
        <ellipse
            cx="637.604"
            cy="573.748"
        ...
        ></ellipse>
        <circle cx="334.037" cy="440.428" r="14.359" fill="#fff"></circle>
        <ellipse
            cx="597.87"
            cy="515.084"
            fill="#3f3d56"
        ...
        <path
            fill="#c6a969"
            d="M370.12 405c.632-15.554-12.773-28.728-29.941-29.426s-31.597 11.346-32.229 26.9 11.302 19.087 28.47 19.785 33.068-1.706 33.7-17.26"
        ></path>
        <ellipse
            cx="644.388"
            cy="537.568"
        ...
        <path
            fill="#fff"
            d="M348.517 467.26a9.572 9.572 0 0 1-18.836 3.43l-.003-.019c-.942-5.202 3.08-7.043 8.282-7.985s9.615-.627 10.557 4.575"
        ></path>
        <path
            fill="#ccc"
            d="M266 495.394a2 2 0 0 1-2-2v-118a2 2 0 0 1 4 0v118a2 2 0 0 1-2 2M236 601.394a2 2 0 0 1-2-2v-86a2 2 0 1 1 4 0v86a2 2 0 0 1-2 2M313 530.394a2 2 0 0 1-2-2v-118a2 2 0 1 1 4 0v118a2 2 0 0 1-2 2M284 615.394a2 2 0 0 1-2-2v-48a2 2 0 1 1 4 0v48a2 2 0 0 1-2 2M325 369.394a2 2 0 0 1-2-2v-48a2 2 0 0 1 4 0v48a2 2 0 0 1-2 2M225 390.394a2 2 0 0 1-2-2v-48a2 2 0 0 1 4 0v48a2 2 0 0 1-2 2M399 395.394a2 2 0 0 1-2-2v-48a2 2 0 1 1 4 0v48a2 2 0 0 1-2 2M395 545.394a2 2 0 0 1-2-2v-58a2 2 0 1 1 4 0v58a2 2 0 0 1-2 2M355 596.394a2 2 0 0 1-2-2v-86a2 2 0 1 1 4 0v86a2 2 0 0 1-2 2M363 449.394a2 2 0 0 1-2-2v-118a2 2 0 1 1 4 0v118a2 2 0 0 1-2 2"
        ></path>
        <ellipse
            cx="858.104"
            cy="764.783"
        ...
        <path
            fill="#ccc"
            d="M535.04 622.366c3.845-15.487 20.82-24.601 37.914-20.357s27.834 20.24 23.989 35.728-16.604 15.537-33.698 11.292-32.051-11.176-28.206-26.663"
        ></path>
        <ellipse
            cx="763.788"
            cy="737.322"
        ...
        ></ellipse>
        <circle cx="542.124" cy="667.415" r="14.359" fill="#fff"></circle>
        <circle cx="536.222" cy="662.268" r="4.786" fill="#3f3d56"></circle>
        <circle cx="542" cy="697.394" r="6" fill="#fff"></circle>
        <path
            fill="#3f3d56"
            d="M671.532 738.394h-236a1 1 0 0 1 0-2h236a1 1 0 0 1 0 2"
        ></path>
    </svg>
);
